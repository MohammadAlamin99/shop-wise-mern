            ...
            {cartList.length > 0 ? (
              cartList.map((product, id) => (
                <div key={id} className="ah-cart-item">
                  <div className="ah-product-info">
                    ...
                    <div className="ah-product-details">
                      <div className="ah-product-name">
                        ...
                        <div className="phone-price-ah">TK. {product.price}</div>
                      </div>
                      <div className="ah-product-color">
                        Color : {product.color}
                        <svg onClick={() => removeItem(product.productID)} className="phone-svg-remove" xmlns="http://www.w3.org/2000/svg" width="24" height="25" viewBox="0 0 24 25" fill="none">
                  ...
                  <div className="ah-price">TK. {product.price}</div>
