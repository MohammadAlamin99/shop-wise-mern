          ...
          <div className="row">
            ...
            <div className="col-md-6">
              <div className="product-info">
                ...
                <h1 className="product-title common_main_head">Tray Table</h1>
                ...
                {/* <div className="offer-countdown mt-4">
                  <p className="offer-text">Offer expires in:</p>
                ...
                <button className="addtocartBtn-main">Add to Cart</button>
                ...
                <div className="product-details mt-4">
                  ...
                  <div className="row">
                    ...
                    <div className="col-8">
                      <p className="detail-value">Living Room, Bedroom</p>
                    </div>
                  </div>
                </div>
              </div>
