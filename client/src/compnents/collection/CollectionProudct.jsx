...
import { productByCategoryRequest, productByCollectionRequest } from "../../apiRequest/apiRequiest";
...
//   const dispatch = useDispatch();
  ...
  useEffect(() => {
    (async () => {
      let result = await productByCollectionRequest(id);
      setpData(result);
    })();
  }, []);
...
export default CollectionProudct;
