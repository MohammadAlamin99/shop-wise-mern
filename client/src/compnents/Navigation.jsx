...
const Navigation = () => {
  ...
  const handleSearchChange = (e) => {
    ...
    // Mock search results - in a real app, you would fetch from an API
    if (query.trim() !== "") {
  ...
  const cartItemCount =
    cartListData && cartListData.data && cartListData.data.data && cartListData.data.data.length > 0
      ? cartListData.data.data.length
      : 0
